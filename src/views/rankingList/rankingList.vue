...
export default {
    ...
    methods: {
        initEcharts() {
            ...
            var data = [1144.3, 1097.8, 1089.1, 1083.8,
                1080.8, 1080.7, 1077.6, 1075.7,
                1073.1, 1055.6, 1042.2, 1021.4,
                1001.1, 1000.0, 990.2, 984.6,
                984.4, 974.2, 972.1, 968.8,
                962.7, 954.6, 948.7, 931.7,
                910.6, 894.3, 825.3, 812.5];
